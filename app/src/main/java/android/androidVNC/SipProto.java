...
class SipProto {
  ...
  final static String TAG = "SipProto";
	
  final static String
    versionMsg_1_0 = "SIP 1.0\n";
...
*/
  // If true, informs that the SIP socket was closed.
  private boolean closed;


  //
  // Constructor. Make TCP connection to SIP server.
  //

  SipProto(String h, int p) throws IOException{
    host = h;
    port = p;
...
*/
  ...
  int readServerMessage() throws IOException {
